...
class _PotholeDetectionScreenState extends State<PotholeDetectionScreen> {
  ...
  Future<void> _pickImageFromSource(ImageSource source) async {
    ...
    // ✅ Show loading modal safely (before async gap)
    LoadingModal.show(
      context,
  ...
  Future<void> _confirmReport() async {
    ...
    // ✅ Compact loading modal for report saving
      ...
      body: SafeArea(
        child: Stack(
          children: [
            ...
            // ⚠️ No inline CircularProgressIndicator anymore (modal replaces it)

            // Bottom card with tags and buttons
